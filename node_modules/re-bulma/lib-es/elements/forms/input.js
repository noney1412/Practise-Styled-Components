...
export default class Input extends Component {
  ...
  createInputClassName() {
    return [styles.input, this.props.isExpanded ? styles.isExpanded : '', styles[this.props.color], styles[this.props.size]].join(' ').trim();
  }
  ...
  renderInput() {
    return React.createElement('input', _extends({}, getCallbacks(this.props), {
  ...
  render() {
    ...
    return React.createElement(
      ...
      this.renderInput(),
      this.props.icon ? React.createElement('i', { className: [styles.fa, this.props.icon].join(' ') }) : null,
      this.renderHelp()
    );
  }
}
